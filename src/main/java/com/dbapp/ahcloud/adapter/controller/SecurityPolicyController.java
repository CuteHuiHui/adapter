package com.dbapp.ahcloud.adapter.controller;

import com.alibaba.fastjson.JSONObject;
import com.dbapp.ahcloud.adapter.req.IpsPolicyReq;
...
public class SecurityPolicyController {
    ...
    @PostMapping({"/policy"})
    public void addSecurityPolicy(@RequestBody String requestString, @RequestHeader(value = "origin_json",required = false) String originHeader) {
        log.info("Request content is: " + requestString + ", origin header is: " + originHeader);
        SecurityPolicyReq securityPolicyReq = JSONObject.parseObject(JSONObject.parseObject(requestString).getJSONObject("data").toJSONString(), SecurityPolicyReq.class);
...
//    public String deleteSecurityPolicy(@PathVariable("policy_id") String policyId, @RequestHeader("origin_json") String originHeader) {
//        log.info("Request policy_id: " + policyId + ", origin header is: " + originHeader);
//        String responseJSON = null;
//
//        try {
//            responseJSON = this.normalizationService.normalizationInterface("DELETE", originHeader, (String)null);
...
//    public String modifySecurityPolicy(@PathVariable("policy_id") String policyId, @RequestHeader("origin_json") String originHeader, @RequestBody String requestString) {
//        log.info("Request policy_id: " + policyId + ",origin header is: " + originHeader);
//        String responseJSON = null;
//
//        try {
//            responseJSON = this.normalizationService.normalizationInterface("PUT", originHeader, requestString);
